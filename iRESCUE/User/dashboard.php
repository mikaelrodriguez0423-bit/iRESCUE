...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <?php if (is_user()): ?>
            <a href="../User/report_emergency.php" class="btn btn-primary">
        ...
        <?php endif; ?>
        <?php if (is_responder()): ?>
            <a href="../User/responder_hub.php" class="btn btn-primary">
...
<div class="cta-card mb-4">
    ...
    <a href="../User/report_emergency.php" class="btn btn-lg">Report Now</a>
</div>
<?php endif; ?>
...
<div class="dashboard-grid">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <?php if (is_admin()): ?>
                <a href="../User/post_alert.php" class="btn btn-sm btn-ghost">+ Post</a>
            <?php endif; ?>
        </div>
