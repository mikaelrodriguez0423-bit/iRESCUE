...
<div class="auth-card">
    ...
    <form id="login-form" method="POST" action="../Auth/login.php" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <a href="../Auth/forgot_password.php" class="form-hint" style="color:var(--red);float:right">Forgot password?</a>
        </div>
