...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <nav class="sidebar-nav">
            <ul>
                <li>
                    <a href="index.php" class="<?php echo in_array($current, ['index.php','dashboard.php']) ? 'active' : ''; ?>">
                ...
                <?php if (is_responder()): ?>
                <li>
                    <a href="responder_hub.php" class="<?php echo $current === 'responder_hub.php' ? 'active' : ''; ?>">
                ...
                <?php if (is_user()): ?>
                <li>
                    <a href="report_emergency.php" class="<?php echo $current === 'report_emergency.php' ? 'active' : ''; ?>">
    ...
    <div class="sidebar-section">
        ...
        <nav class="sidebar-nav">
            <ul>
                <li>
                    <a href="locator.php" class="<?php echo $current === 'locator.php' ? 'active' : ''; ?>">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Safety Locator
                    </a>
                </li>
                <li>
                    <a href="hotlines.php" class="<?php echo $current === 'hotlines.php' ? 'active' : ''; ?>">
    ...
    <div class="sidebar-section">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li>
                    <a href="manage_locations.php" class="<?php echo $current === 'manage_locations.php' ? 'active' : ''; ?>">
                ...
                <li>
                    <a href="manage_hotlines.php" class="<?php echo $current === 'manage_hotlines.php' ? 'active' : ''; ?>">
                ...
                <li>
                    <a href="activity_log.php" class="<?php echo $current === 'activity_log.php' ? 'active' : ''; ?>">
