...
if ($action === 'delete' && isset($_GET['id'])) {
    ...
    header('Location: ../Admin/manage_locations.php?toast=success&msg=Location+deleted.'); exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && csrf_verify()) {
    ...
    if (empty($name) || empty($address) || !in_array($type, $types)) {
        ...
        header('Location: ../Admin/manage_locations.php?toast=success&msg=Location+added.'); exit;
        ...
        header('Location: ../Admin/manage_locations.php?toast=success&msg=Location+updated.'); exit;
    }
}
        ...
        <table id="locations-table">
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="../Admin/manage_locations.php?action=delete&id=<?php echo $loc['id']; ?>"
...
<div id="crud-modal-overlay" class="modal-overlay">
    <div class="modal">
        ...
        <div class="modal-body">
            <form id="crud-form" method="POST" data-base-action="../Admin/manage_locations.php" action="../Admin/manage_locations.php?action=add">
                <?php echo csrf_field(); ?>
