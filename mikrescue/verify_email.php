...
if (!$user) {
    ...
    $success = 'Your account is already verified. <a href="login.php">Log in &rarr;</a>';
} else {
    ...
    if ($stmt->execute()) {
        ...
        $success = "Your account has been verified, <strong>{$user['username']}</strong>! <a href='login.php'>Log in now &rarr;</a>";
    } else {
