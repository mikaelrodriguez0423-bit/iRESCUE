...
if ($action === 'delete' && isset($_GET['id'])) {
    ...
    header('Location: ../Admin/manage_hotlines.php?toast=success&msg=Hotline+deleted.'); exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && csrf_verify()) {
    ...
    if (empty($service) || empty($number)) {
        ...
        header('Location: ../Admin/manage_hotlines.php?toast=success&msg=Hotline+added.'); exit;
        ...
        header('Location: ../Admin/manage_hotlines.php?toast=success&msg=Hotline+updated.'); exit;
    }
}
        ...
        <table id="hotlines-table">
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="../Admin/manage_hotlines.php?action=delete&id=<?php echo $h['id']; ?>"
...
<div id="crud-modal-overlay" class="modal-overlay">
    <div class="modal">
        ...
        <div class="modal-body">
            <form id="crud-form" method="POST" data-base-action="../Admin/manage_hotlines.php" action="../Admin/manage_hotlines.php?action=add">
                <?php echo csrf_field(); ?>
